					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							...
							<div class="description-container m-t-20">
								@if(session()->get('language') == 'chinese') {{$product->short_description_cn}}
                                @elseif(session()->get('language') == 'vietnamese') {{$product->short_description_vn}}
                                @else {{$product->short_description_en}}
                                @endif 
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">
                                            @if(session()->get('language') == 'chinese') {!!$product->long_description_cn!!}
                                            @elseif(session()->get('language') == 'vietnamese') {!!$product->long_description_vn!!}
                                            @else {!!$product->long_description_en!!}
                                            @endif 
                                        </p>
									</div>	
								</div><!-- /.tab-pane -->
