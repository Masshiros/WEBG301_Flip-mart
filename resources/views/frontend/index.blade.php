            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                ...
                <div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'chinese') 热卖
                        @elseif(session()->get('language') == 'vietnamese') ưu đãi lớn
                        @else hot deals
                        @endif 
                    </h3>
                    <div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
                        @foreach($hot_dealProduct as $product)
                        <div class="item">
                            <div class="products">
                ...
                <div class="sidebar-widget outer-bottom-small wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'chinese') 特价
                        @elseif(session()->get('language') == 'vietnamese') khuyến mãi đặc biệt
                        @else Special Offer
                        @endif 
                    </h3>
               ...
               @include('frontend.common.product_tags')
                ...
                <div class="sidebar-widget outer-bottom-small wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'chinese') 特别优惠
                        @elseif(session()->get('language') == 'vietnamese') Ưu đãi đặc biệt
                        @else Special Deals
                        @endif
                    </h3>
                    <div class="sidebar-widget-body outer-top-xs">
                        <div
                            ...
                            <div class="item">
                                <div class="products special-product">
                                @foreach($special_dealsProduct as $product)
                                    <div class="product">
                                        <div class="product-micro">
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                ...
                <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                    ...
                    @foreach($categories as $category)
                        <div class="tab-pane" id="category{{$category->id}}">
                            ...
                            @php
                            $catwiseproduct = App\Models\Product::whereHas('subsubcategory.subcategory.category', function ($query) use ($category) {
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        ...
                        @elseif(session()->get('language') == 'vietnamese') Sản phẩm nổi bật
