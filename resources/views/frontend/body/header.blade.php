            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        ...
                        @if(session()->get('language') == 'chinese') 轮廓
                        @elseif(session()->get('language') == 'vietnamese') Hồ sơ của tôi
                        @else My Profile
                        @endif
                        </a></li>
                        ...
                        <li>
                            ...
                            @if(session()->get('language') == 'chinese') 用户资料
                            @elseif(session()->get('language') == 'vietnamese') Thông tin người dùng
                            @else User Profile
                            @endif
                            </a>
                            @else 
                            <a href="{{route('login')}}"><i class="icon fa fa-lock"></i>
                            @if(session()->get('language') == 'chinese') 登录/注册
                            @elseif(session()->get('language') == 'vietnamese') Đăng nhập/Đăng ký
                            @else Login/Register
                            @endif
                            </a>
                            @endauth
                ...
                <div class="cnt-block">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle"
                                ...
                                @if(session()->get('language') == 'chinese') 语言
                                @elseif(session()->get('language') == 'vietnamese') Ngôn Ngữ
                                @else Language
                                @endif
                                     </span><b
                                    class="caret"></b></a>
                        ...
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                <li class="active dropdown yamm-fw"> <a href="{{url('/')}}"  data-hover="dropdown"
                                    ...
                                    @if(session()->get('language') == 'chinese') 主页
                                    @elseif(session()->get('language') == 'vietnamese') TRANG CHỦ
                                    @else HOME
                                    @endif
                                    </a> </li>
                                <!-- Get category data -->
