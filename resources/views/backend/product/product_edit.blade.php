                        ...
                        <div class="row"> <!--Start 7th row -->
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="short_description_en" id="textarea" class="form-control"  placeholder="Textarea text" ">{!! $product->short_description_en!!}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="short_description_vn" id="textarea" class="form-control"  placeholder="Textarea text" >{!! $product->short_description_vn!!}</textarea>
            ...
            <div class="col-md-12">
                ...
                <form action="{{route('product.update-image')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-md-3">
                            <div class="card" ">
                                ...
                                <div class="card-body">
                                  <h5 class="card-title">
                                    <a href="{{route('product.multi.delete',$img->id)}}" id="delete" class="btn btn-sm btn-danger" title="Delete Data"><i class="fa fa-trash"></i></a>
                                  </h5>
                                  <p class="card-text">
                                    <div class="form-group">
                    ...
                    <div class="form-layout-footer">
                        <div class="text-xs-right">
                            <input type="submit" value="Update Image" class=" btn btn-rounded btn-primary mb-5">
                        </div>
                    </div>
                    <br>
                    <br>
                            ...
                            <div class="card" ">
                                ...
                                <div class="card-body">
                                  ...
                                  <p class="card-text">
                                    <div class="form-group">
                                        <label for="" class="form-control-label">Change Image <span class="tx-danger">*</span> </label>
                                        <input type="file" name="product_thumbnail" id="" class="form-control" onChange="mainThumbUrl(this)">
