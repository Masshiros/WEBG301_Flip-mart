                    ...
                    @endif
                        ...
                        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                                <h3 href="#">
                                    <svg class="h-16 w-auto text-gray-700 sm:h-20" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none"stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="#"><path d="M12 4h9"/>
                                        <path d="M5.2 20h0A7.28 7.28 0 0 1 12 14.85"/>
                                        <path d="M5.2 4h0a7.28 7.28 0 0 0 6.85.15"/>
                                        <circle cx="12" cy="10" r="3"/></svg>
                                    <img src="{{asset('backend/images/LogoWeb.png')}}" alt="">
                                </h3>
                            </div>
