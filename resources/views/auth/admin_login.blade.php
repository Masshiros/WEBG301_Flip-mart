...
<head>
    ...
    <title>Flip Mart Admin - Log in </title>
                        ...
                        <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            ...
                            <div class="text-center text-white">
                                ...
                                <p class="gap-items-2 mb-20">
                                    ...
                                    <a class="btn btn-social-icon btn-round btn-outline btn-white" href="https://twitter.com/"><i
                                            class="fa fa-twitter"></i></a>
                                    <a class="btn btn-social-icon btn-round btn-outline btn-white" href="https://www.google.com/"><i
                                            class="fa fa-google-plus"></i></a>
                                    <a class="btn btn-social-icon btn-round btn-outline btn-white" href="https://www.instagram.com/s"><i
