...
<body class="hold-transition theme-primary bg-gradient-primary">
    ...
    <!-- Vendor JS -->
    <script src="backend/css/skin_color.cssbackend/js/vendors.min.js"></script>
    <script src="backend/css/skin_color.cssbackend/assets/icons/feather-icons/feather.min.js"></script>
