...
<div class="container-full">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
                    ...
                    success: function(data){
                        ...
                        $.each(data,function(key,value){
                            var option = $('<option></option>')
                                        .attr('value', value.id)
                                        .text(value.subcategory_name_en);
                            if (value.id == '{{ $subsubcategories->subcategory_id }}') {
        ...
        var currentSubcategoryId = '{{ $subsubcategories->subcategory_id }}';
        if (currentSubcategoryId) {
            $('select[name="subcategory_id"]').val(currentSubcategoryId);
        }
    });
</script>
@endsection