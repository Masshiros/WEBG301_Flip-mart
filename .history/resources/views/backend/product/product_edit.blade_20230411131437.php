                       	...
                       	<div class="row"> <!-- Start 6th row-->
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_color_cn" class="form-control" value="{{$product->product_tags_cn}}" data-role="tagsinput" >
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_color_vn" class="form-control" value="{{$product->product_tags_en}}" data-role="tagsinput" >
