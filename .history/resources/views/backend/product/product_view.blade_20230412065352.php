                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="30%">
                                ...
                                @if($item->status == 1)
                                <a href="{{route('product.edit', $item->id)}}" class="btn btn-danger" title="Product Details Data"> <i class="fa fa-arrow-down"></i></a>
                                @else
                                <a href="{{route('product.edit', $item->id)}}" class="btn btn-primary" title="Product Details Data"> <i class="fa fa-arrow-up"></i></a>
                                @endif
                              </td>
