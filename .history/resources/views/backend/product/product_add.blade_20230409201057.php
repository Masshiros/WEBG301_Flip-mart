                        ...
                        <div class="row"> <!--Start 3rd row-->
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="selling_pricew" class="form-control" >
                                        @error('selling_pricew')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                    </div>
                                </div>
                       	...
                       	<div class="row"> <!-- Start 6th row-->
                            <div class="col-md-4">
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_color_en" class="form-control" value="Small, Medium, Large" data-role="tagsinput" >
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_color_cn" class="form-control" value="小, 中, 大" data-role="tagsinput" >
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_color_vn" class="form-control" value="Nhỏ,Vừa,To" data-role="tagsinput" >
