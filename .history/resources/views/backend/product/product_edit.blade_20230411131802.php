                        ...
                        <div class="row"> <!--Start 9th row -->
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="long_description_en" id="editor1" rows="10" cols="80" class="form-control" required placeholder="Textarea text" value="{{$product->long_description_en}}">{!! $product->short_description_cn!!}</textarea>
