                        ...
                        <div class="row"> <!--Start 8th row -->
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="long_description_vn" id="editor1" rows="10" cols="80"  class="form-control" required placeholder="Textarea text"></textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="long_description_cn" id="editor1" rows="10" cols="80" class="form-control" required placeholder="Textarea text"></textarea>
