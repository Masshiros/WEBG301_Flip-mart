...
class ProductController extends Controller
{
    ...
    public function StoreProduct(Request $request)
    {
        $request->validate([
            ...
            'product_tags_en.required' => 'Please add some english ta',
            'product_tags_vn.required' => 'Please add some english ta',
            'product_tags_cn.required' => 'Please add some english ta',
