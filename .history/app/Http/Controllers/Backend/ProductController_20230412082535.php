...
class ProductController extends Controller
{
    ...
    public function StoreProduct(Request $request)
    {
        $request->validate([
            ...
            'brand_id.required' => 'require',
            'subsubcategory_id.required' => 'require',
            'product_name_en.required' =>'require',
            'product_name_cn.required' =>'require',
            'product_name_vn.required' => 'require',
            'product_slug_en.required' => 'require',
            'product_slug_vn.required' => 'require',
            'product_slug_cn.required' => 'require',
