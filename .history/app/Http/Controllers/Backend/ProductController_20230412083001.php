...
class ProductController extends Controller
{
    ...
    public function StoreProduct(Request $request)
    {
        $request->validate([
            ...
            'short_description_vn.required' => 'Please add some short description in english',
            'short_description_cn.required' => 'Please add some short description in english',
            'long_description_en.required' => 'Please add some short description in english',
            'long_description_vn.required' => 'Please add some short description in english',
            'long_description_cn.required' => 'Please add some short description in english',
