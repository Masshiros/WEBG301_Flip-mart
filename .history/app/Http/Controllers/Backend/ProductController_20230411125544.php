...
class ProductController extends Controller
{
    ...
    public function EditProduct($id){
        $categories = Category::latest()->get();
        $brand = Brand::lastest()->get();
        $subcategories = SubCategory::lastest()->get();
        $subsubcategories = SubSubCategory::lastest()->get();
        $product = Product::findOrFail($id);
        return view('backend.product.product_edit',compact('categories','brand','subcategories','subsubcategories','product'));
    }
}