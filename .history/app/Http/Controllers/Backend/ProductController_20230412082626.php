...
class ProductController extends Controller
{
    ...
    public function StoreProduct(Request $request)
    {
        $request->validate([
            ...
            'product_name_cn.required' =>'Please input english name of product',
            'product_name_vn.required' => 'Please input english name of product',
            'product_slug_en.required' => 'Please input english name of product',
            'product_slug_vn.required' => 'Please input english name of product',
            'product_slug_cn.required' => 'Please input english name of product',

            'product_code.required' =>'require',
            'product_quantity.required' => 'require',
