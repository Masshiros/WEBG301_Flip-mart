...
Route::prefix('subcategory')->group(function () {
    //1) Display All CATEGORY
    Route::get('/view', [CategoryController::class, 'CategoryView'])->name('all.subcategory');
    //2 ) ADD NEW CATEGORY
    ...
    //4) UPDATE CATEGORY IN DATABASE
    Route::post('/update', [CategoryController::class, 'CategoryUpdate'])->name('subcategory.update');
    //5) DELETE CATEGORY
