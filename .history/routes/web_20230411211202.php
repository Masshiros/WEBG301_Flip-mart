...
Route::prefix('product')->group(function () {
    ...
    //5) Update Edited Product
    Route::post('/data/update',[ProductController::class, 'Product'])->name('product.update');
    //5) Update Edited Product
    Route::post('/image/update',[ProductController::class, 'UpdateProduct'])->name('product.update-image');
    //6) DELETE PRODUCT
