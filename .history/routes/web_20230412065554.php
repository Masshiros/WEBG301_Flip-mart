...
Route::prefix('product')->group(function () {
    ...
    //6) DELETE PRODUCT
    Route::get('/multidelete/{id}',[ProductController::class, 'DeleteMultiImage'])->name('product.multi.delete');
    //6) DELETE PRODUCT
    Route::get('/delete/{id}',[ProductController::class, 'DeleteMultiImage'])->name('product.inactive');
    //6) DELETE PRODUCT
    Route::get('/delete/{id}',[ProductController::class, 'DeleteMultiImage'])->name('product.active');
