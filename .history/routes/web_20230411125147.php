...
Route::prefix('product')->group(function () {
    ...
    Route::store('/update',[ProductController::class, 'UpdateProduct'])->name('product.update');
    //6) DELETE PRODUCT
    Route::get('/delete/{id}',[ProductController::class, 'DeleteProduct'])->name('product.edit');
