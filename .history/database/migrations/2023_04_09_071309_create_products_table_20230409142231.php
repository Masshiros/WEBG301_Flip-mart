...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->id('product_size_en')->nullable();
            $table->id('product_size_vn')->nullable();
            $table->id('product_size_cn')->nullable();
            $table->id('product_color_en');
            $table->id('product_color_vn');
            $table->id('product_color_cn');
            $table->id('selling_price');
            $table->id('discount_price')->nullable();
            ...
            $table->id('special_deals')->nullable();
